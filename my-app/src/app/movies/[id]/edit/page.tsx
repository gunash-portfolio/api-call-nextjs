...
export default function EditMovie() {
  ...
  if (error && isLoading) return <div className="flex justify-center items-center min-h-screen text-red-500">Error: {error}</div>;

  return (
    <main className="min-h-screen p-8 md:p-12 lg:p-24">
      <div className="max-w-2xl mx-auto">
        <Link href={`/movies/${id}`} className="text-blue-500 hover:text-blue-700 mb-6 inline-block">
